            ...
            <div className='flex flex-col space-y-2'>
                ...
                <hr />
                {
                    filters.categories.map((category) => (
                        <label key={category} className='capatilize cursor-pointer'>
            ...
            <div className='flex flex-col space-y-2'>
                ...
                <hr />
                {
                    filters.colors.map((color) => (
                        <label key={color} className='capatilize cursor-pointer'>
            ...
            <div className='flex flex-col space-y-2'>
                ...
                <hr />
                {
                    filters.priceRanges.map((range) => (
                        <label key={range.label} className='capatilize cursor-pointer'>
                            <input type="radio" name="priceRanges" id="priceRanges" value={`${range.min} - ${range.max}`}
